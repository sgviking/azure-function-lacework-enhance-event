...
def main(req: func.HttpRequest) -> func.HttpResponse:
    def get_csp_info(alert):
        ...
        if entityMap.get('Machine', False):
            alert['aws_account_id'] = entityMap.Machine[1].get('PROPS', {}).get('tags', {}).get('Account'))
            alert['ic:site_id'] = entityMap.Machine[1].get('PROPS', {}).get('tags', {}).get('ic:siteid'))
            alert['ic:vcs_account_id'] = entityMap.Machine[1].get('PROPS', {}).get('tags', {}).get('ic:vcs-account-id')
            alert['site_id'] = entityMap.Machine[1].get('PROPS', {}).get('tags', {}).get('siteid'))
            alert['vcs_account_id'] = entityMap.Machine[1].get('PROPS', {}).get('tags', {}).get('vcs-account-id')
            return alert
